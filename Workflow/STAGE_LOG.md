...
| 2026-07-16 | Stage 4 | in review | Vytvořena prezentace od návaznosti na předchozí lekci přes lineární model až k diagnostice residuí | `Workflow/records/2026-07-16-stage-4-slides.md` | `lesson/l03-presentation` / pending | TBD |
